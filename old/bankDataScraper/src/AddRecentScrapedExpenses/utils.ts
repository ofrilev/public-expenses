import { transactionObj} from "shared-utils/dist";

export function isFstFileDateGreaterThenSnd(filename1:string, filename2:string) {
...
export function difference(obj1: transactionObj[], obj2: transactionObj[]): transactionObj[] {
    const obj3: transactionObj[] = [];

    for (const item1 of obj2) {
        const existsInObj1 = obj1.some(item2 =>
